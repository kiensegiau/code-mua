  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              >
                Các khóa học dành riêng cho học sinh lớp 11, được biên soạn kỹ
                lưỡng bởi đội ngũ giáo viên hàng đầu
              </motion.p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mt-6">
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Đi sâu vào từng môn học chuyên biệt
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div>
                <p className="text-white font-medium">Luyện đề thi học kỳ</p>
                <p className="text-gray-400 text-sm">
            ...
            >
              ...
              <div>
                <p className="text-white font-medium">Tư vấn định hướng</p>
                <p className="text-gray-400 text-sm">
                  Hỗ trợ chọn ban, định hướng ngành nghề
                </p>
              </div>
            </motion.div>
          </div>
        ...
        >
          <p>Các khóa học lớp 11 được cập nhật thường xuyên</p>
