...
function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#141414] text-gray-200 relative overflow-hidden">
      {/* Progress Bar */}
      <motion.div
          ...
          <div className="max-w-[1200px] mx-auto px-4 md:px-6 py-4 md:py-6">
            ...
            >
              ...
              <div className="relative px-4 md:px-8">
                ...
                >
                  Khóa học online chất lượng cao dành cho học sinh THPT, giúp
                  nâng cao điểm số và tự tin trong kỳ thi Đại học
                </motion.p>
                <motion.div
                  variants={fadeInUp}
                  initial="initial"
